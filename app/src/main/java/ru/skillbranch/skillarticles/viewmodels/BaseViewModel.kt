...
abstract class BaseViewModel<T>(initState: T, val savedStateHandle: SavedStateHandle) : ViewModel() where T: VMState{
    ...
    /***
     * вспомогательгая функция позволяющая наблюдать за изменениями части стейта ViewModel
     */
